...
<!-- Sidebar Navigation -->
<aside id="user-sidebar" class="fixed left-0 top-0 h-screen w-64 bg-gray-900 border-r border-gray-800 transform lg:translate-x-0 transition-transform duration-300 ease-in-out z-40 overflow-y-auto scrollbar-hide" style="transform: translateX(0);">
    ...
    <nav class="px-4 py-6 space-y-2">
        ...
        <div class="mb-8">
            ...
            <a href="book-appointment.php" class="sidebar-link flex items-center gap-3 px-4 py-3 text-gray-300 hover:text-white hover:bg-gray-800 rounded-lg transition-all duration-200">
                <span class="material-symbols-outlined text-xl">add_circle</span>
                <span>Book Appointment</span>
            </a>

            <a href="upcoming-appointments.php" class="sidebar-link flex items-center gap-3 px-4 py-3 text-gray-300 hover:text-white hover:bg-gray-800 rounded-lg transition-all duration-200">
                <span class="material-symbols-outlined text-xl">calendar_today</span>
                <span>Upcoming</span>
            </a>

            <a href="appointment-history.php" class="sidebar-link flex items-center gap-3 px-4 py-3 text-gray-300 hover:text-white hover:bg-gray-800 rounded-lg transition-all duration-200">
        ...
        <!-- Services Section -->
        <div class="mb-8">
            <h3 class="px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">Services</h3>
            ...
            <a href="ai-message-support.php" class="sidebar-link flex items-center gap-3 px-4 py-3 text-gray-300 hover:text-white hover:bg-gray-800 rounded-lg transition-all duration-200">
        ...
        <!-- Analytics Section -->
        <div class="mb-8">
            <h3 class="px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">Analytics</h3>
    ...
    <div class="flex items-center justify-between px-4 md:px-6 h-full">
        ...
        <div class="flex items-center gap-2 md:gap-4 ml-auto">
            ...
            <div class="hidden md:flex items-center gap-3 ml-2 pl-4 border-l border-gray-200">
                ...
                <img src="https://via.placeholder.com/40" alt="User Avatar" class="w-10 h-10 rounded-full bg-gray-300">
            </div>
