    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 mb-12">
            ...
            <div class="col-span-1 lg:col-span-1">
                <a href="/public/index.php" class="text-2xl font-bold text-gray-100 tracking-tight mb-4 inline-block">
                    Repairmax
                </a>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    ...
                    <li><a href="#" class="hover:text-gray-100 hover:underline underline-offset-4 transition-all duration-300">Track Status</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    <li><a href="/public/login.php" class="hover:text-gray-100 hover:underline underline-offset-4 transition-all duration-300">Log In</a></li>
                    <li><a href="/public/registration.php" class="hover:text-gray-100 hover:underline underline-offset-4 transition-all duration-300">Register</a></li>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    <li><a href="#" class="hover:text-gray-100 hover:underline underline-offset-4 transition-all duration-300">Privacy Policy</a></li>
                    <li><a href="#" class="hover:text-gray-100 hover:underline underline-offset-4 transition-all duration-300">Terms of Service</a></li>
                    <li><a href="#" class="hover:text-gray-100 hover:underline underline-offset-4 transition-all duration-300">Refund Policy</a></li>
                    <li><a href="#" class="hover:text-gray-100 hover:underline underline-offset-4 transition-all duration-300">Warranty Info</a></li>
                </ul>
            </div>
