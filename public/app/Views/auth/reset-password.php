...
<head>
    ...
    <title>Reset Password | Repairmax</title>
    ...
    <div class="hidden lg:flex lg:col-span-5 bg-gray-900 text-gray-100 p-12 flex-col justify-between">
        ...
        <div>
            ...
            <p class="text-gray-500 text-lg max-w-md">
                Choose a strong, unique password to keep your service tickets and device information safe.
            </p>
        </div>
    ...
    <div class="col-span-12 lg:col-span-7 flex flex-col justify-center p-8 sm:p-12 lg:p-20 relative">
        ...
        <div class="w-full max-w-md mx-auto mt-12 lg:mt-0">
            ...
            <form action="#" method="POST" class="space-y-6">
                ...
                <input type="hidden" name="token" value="placeholder_token_value">
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" onclick="togglePassword('newPassword', 'eyeIcon1')" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-500 hover:text-gray-700">
