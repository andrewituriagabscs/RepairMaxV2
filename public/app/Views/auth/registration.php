...
<head>
    ...
    <title>Register | Repairmax</title>
...
<body class="min-h-screen grid grid-cols-12 bg-gray-100 text-gray-900 font-sans antialiased">
    ...
    <div class="hidden lg:flex lg:col-span-5 bg-gray-900 text-gray-100 p-12 flex-col justify-between">
        ...
        <div>
            ...
            <p class="text-gray-500 text-lg max-w-md">
                Create an account to manage your service tickets, schedule appointments, and track your device repairs seamlessly.
            </p>
        </div>
    ...
    <div class="col-span-12 lg:col-span-7 flex flex-col justify-center p-8 sm:p-12 lg:p-20 relative">
        ...
        <div class="w-full max-w-2xl mx-auto mt-12 lg:mt-0">
            ...
            <form action="#" method="POST" class="space-y-6">
                ...
                <div>
                    <label for="otp" class="block text-sm font-medium text-gray-700 mb-2">Verification Code (OTP)</label>
                    <div class="flex gap-4">
                        <input type="text" id="otp" name="otp" placeholder="Enter 6-digit code" required
                            class="w-full bg-gray-100 border border-gray-400 text-gray-900 rounded-md px-4 py-3 focus:outline-none focus:border-gray-800 focus:ring-1 focus:ring-gray-800 transition-colors">
                        <button type="button" class="whitespace-nowrap bg-gray-200 text-gray-800 hover:bg-gray-300 px-6 py-3 rounded-md font-medium transition-colors border border-gray-300">
                            Send OTP
                        </button>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-12 gap-6">
                    <div class="col-span-12 sm:col-span-6 relative">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" onclick="togglePassword('password', 'eyeIcon1')" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-500 hover:text-gray-700">
                    ...
                    <div class="col-span-12 sm:col-span-6 relative">
                        ...
                        <div class="relative">
                            <input type="password" id="confirmPassword" name="confirmPassword" required
                                class="w-full bg-gray-100 border border-gray-400 text-gray-900 rounded-md px-4 py-3 pr-12 focus:outline-none focus:border-gray-800 focus:ring-1 focus:ring-gray-800 transition-colors">
                            <button type="button" onclick="togglePassword('confirmPassword', 'eyeIcon2')" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-500 hover:text-gray-700">
